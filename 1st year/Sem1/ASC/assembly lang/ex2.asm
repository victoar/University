...
start: 
     ...
     mov  ax, [b] ; we isolate bits 11-15 of A
     and  ax, 0000_0001_1110_0000b
     mov  cl, 5
     ror  ax, cl ; we rotate 11 positions to the right
     or   bx, ax ; we put the bits into the result 1

     mov  ax, [a] ; we isolate bits 0-4 of A
     ...
     mov  ax, [a]
     and  ax, 0001_1111_1100_0000b ; we isolate the bits 6-12 of A
     mov  cl, 3
     rol  ax, cl ; we rotate 4 positions to the left
